...
export interface ICustomClassTypeParams extends ITypeParams {
  ...
  clone?: (
    value: InstanceType<this["constructor"]>,
    stack: any
  ) => InstanceType<this["constructor"]>;
  toJSON?: (value: InstanceType<this["constructor"]>, stack: any) => any;
}

export interface ICustomClassType<T extends new (...args: any[]) => any>
  extends IType {
  <TConstructor extends new (...args: any) => any>(
    params: ICustomClassTypeParams & { constructor: TConstructor }
...
export class CustomClassType extends Type {
  ...
  constructor(
    params: ITypeParams & { constructor: new (...args: any) => any }
  ) {
    super(params);
