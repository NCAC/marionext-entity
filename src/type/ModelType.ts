...
import { CircularStructureToJSONError, InvalidModelError } from "../errors";

export function MakeModelType<
  TModelConstructor extends new (...args: any[]) => Model<any, any>
>(
  params: ITypeParams & {
...
export class ModelType extends Type {
  ...
  Model: new (...args: any) => Model<any, any>;

  constructor(
    params: ITypeParams & { Model: new (...args: any) => Model<any, any> }
  ) {
    super(params);
